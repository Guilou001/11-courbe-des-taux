#set document(title: "Ce que la courbe des taux canadienne permet de prévoir", author: "Guillaume Vaudescal")
#set page(
  paper: "a4",
...
#align(center)[
  #block(width: 100%)[
    #text(size: 18pt, weight: "bold")[Ce que la courbe des taux canadienne permet de prévoir]
    #v(0.6em)
    #text(size: 10pt, fill: luma(70))[Guillaume Vaudescal · 2026-09-04 · #link("https://github.com/Guilou001/11-courbe-des-taux")[Guilou001/11-courbe-des-taux]]
  ]
]
#v(1.2em)
